...
LanguageEnum = Literal[
    "ar", "eu", "be", "bg", "ca", "ck", "zh", "zh-Hans", "zh-Hant",
    "hr", "cs", "da", "nl", "en", "eo", "fi", "fr", "gl", "de",
    "el", "he", "hi", "hu", "ga", "id", "it", "iu", "ja", "kk",
    "ko", "la", "lv", "lt", "mk", "ms", "ne", "no", "fa", "pl",
    "pt-br", "pt-pt", "ro", "ru", "gd", "sr", "sk", "sl", "es",
    "sv", "ta", "th", "tr", "uk", "ur", "vi"
]

# Based on schema["enums"]["platform"]
PlatformEnum = Literal[
    "win", "lin", "mac", "web", "tdo", "ios", "and", "bdp", "dos",
    "dvd", "drc", "nes", "sfc", "fm7", "fm8", "fmt", "gba", "gbc",
    "msx", "nds", "swi", "sw2", "wii", "wiu", "n3d", "p88", "p98",
    "pce", "pcf", "psp", "ps1", "ps2", "ps3", "ps4", "ps5", "psv",
    "smd", "scd", "sat", "vnd", "x1s", "x68", "xb1", "xb3", "xbo",
    "xxs", "mob", "oth"
]

# Based on schema["enums"]["staff_role"]
StaffRoleEnum = Literal[
    "scenario", "director", "chardesign", "art", "music", "songs",
    "translator", "editor", "qa", "staff"
]
...
class QueryRequest:
    ...
    page: int = 1
    user: Optional[VNDBID] = None # User ID (e.g., "u1") for /ulist or 'label' filter context
    count: bool = False
    ...
    def to_dict(self) -> dict:
        ...
        for k, v in self.__dict__.items():
            ...
            elif k == "filters" and not v: # Ensure filters is an empty list if not provided
                data[k] = []
